...
const SumInverseLeftForward := preload("res://algebra/logic/rules/sum/inverse_left_forward.gd")
const SumInverseRightForward := preload("res://algebra/logic/rules/sum/inverse_right_forward.gd")
